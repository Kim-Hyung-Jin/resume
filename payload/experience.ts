  ...
  list: [
    {
      ...
      descriptions: [
        ...
        '- 앱을 통한 플라스틱 교통카드 충전, 이용내역조회, 잔액조회',
        'Android 교통카드 앱 설계, 개발(BBIK 앱)',
        '국내 최초 iOS 교통카드 앱 설계, 개발, 유지보수(BBIK, 레일플러스 앱)',
        '- iOS 앱 기반 교통카드 기능',
        '- 코레일앱 기차권 구매, 제로페이 연동 등 타 플랫폼 연동',
        '- 제로페이, 신용카드, 가상계좌를 통한 교통카드 충전',
        'BBIK 앱(iOS-작업/Android-리딩) MVVM',
        '- 아키텍쳐 리팩터링 (클린 아키텍쳐를 기반으로 지속적인 개선 시도중)',
